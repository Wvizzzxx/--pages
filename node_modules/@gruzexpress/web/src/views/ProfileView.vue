      ...
      <template v-else>
        ...
        <div class="profile-hero">
          ...
          <div class="profile-info">
            ...
            <span v-if="!authStore.user?.emailVerified" class="email-badge email-unverified" @click="resendVerification">
              Email не подтверждён (нажмите для отправки)
            </span>
        ...
        <div v-if="!authStore.isAdmin" class="discount-banner">
          <div class="discount-info">
            <img src="\icons\gift.svg" class="discount-icon"/>
            <div>
        ...
        <div class="quick-actions">
          ...
          <router-link to="/services" class="quick-action-card">
            <img src="\icons\all-services.svg "class="guest-icon"/>
          ...
          <router-link to="/contacts" class="quick-action-card">
            <img src="\icons\phone.svg" class="guest-icon"/>
        ...
        <section class="orders-section">
          ...
          <div v-else-if="orders.length === 0" class="empty-state">
           <img src="\icons\document.svg" class="empty-icon"/>
              ...
              <div class="order-body">
                <div class="order-route">
                  <div class="route-point">
                    <img src="/icons/map-pin.svg" class="route-icon" />
                ...
                <div class="order-meta">
                  <div class="meta-item" v-if="order.createdAt">
                    <img src="/icons/calendar.svg" class="meta-icon"/>
        ...
        <section class="support-section">
          <div class="support-card">
            <img src="\icons\reviews-simple.svg" class="guest-icon"/>
...
.progress-fill {
  height: 100%;
  background: linear-gradient(90deg, var(--color-accent), var(--color-secondary-dark));
  border-radius: var(--radius-full);
