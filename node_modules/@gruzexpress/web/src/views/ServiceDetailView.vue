          ...
          <aside class="service-sidebar">
            <div class="sidebar-card">
              ...
              <ul class="benefits-list">
                <li>
                  <img src="\icons\truck.svg" class="benefit-icon"/>
                  <div>
                ...
                <li>
                  <img src="\icons\clock.svg" class="benefit-icon"/>
                  <div>
                ...
                <li>
                  <img src="\icons\shield.svg" class="benefit-icon"/>
                  <div>
                ...
                <li>
                  <img src="\icons\phone.svg" class="benefit-icon"/>
                  <div>
