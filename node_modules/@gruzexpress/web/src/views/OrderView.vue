  ...
  <main class="order-view">
    <div class="container">
      ...
      <div v-if="submitted" class="success-card">
        <img src="\icons\success.svg" class="success-icon"/>
      ...
      <div class="order-info">
        <div class="info-card">
          <img src="\icons\quick-reply.svg" class="info-icon"/>
          <h3>Быстрый ответ</h3>
          <p>Менеджер свяжется в течение 30 минут</p>
        </div>
        <div class="info-card">
          <img src="\icons\shield.svg" class="info-icon"/>
          <h3>Гарантия</h3>
          <p>Страхование всех грузов</p>
        </div>
        <div class="info-card">
          <img src="\icons\dollar.svg" class="info-icon"/>
          <h3>Лучшие цены</h3>
